...
const Body = () => {
  return (
    <Container fluid className="text-center mt-3 d-flex flex-column">
      <p className='fs-5 animated-delay-one'>I am currently looking for a entry level front-end developer position or freelance work. If you are interested, please contact me!</p>
