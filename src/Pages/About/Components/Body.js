...
const Body = () => {
  return (
    <Container fluid className="col-lg-12 d-flex flex-column align-items-center mt-3 about-body-container">
        <h1 className="about-body-h1-text">Who Am I?</h1>
        <Container fluid className="col-lg-12 d-flex flex-column align-items-center mt-3 text-center" style={{fontFamily: "Inconsolata"}}>
        ...
        <Container fluid className="col-lg-11 d-flex flex-column flex-xl-row justify-content-evenly mt-3 pt-3 pb-3 text-dark about-body-unordered-list-container">
            <ul className="text-center about-me-unordered-list">
